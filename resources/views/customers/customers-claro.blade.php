...
<div class="content-header">
    <div class="container">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"> Busqueda <small>Customers Claro</small></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        $('#tasks').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "bSortable": false,
                    "mRender": function(d) {
                        return '<a href="/customers-claro/' + d.Internal_ID + '" ><i class="fas fa-eye"></i></a>';
                    }
                }
            ],
